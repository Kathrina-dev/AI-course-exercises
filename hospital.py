...
class Space():
    ...
    def hill_climb(self, maximum=None, image_prefix=None, log=False):
        ...
        # Contine until we reach maximum number of iterations
...
for i in range(15):
    s.add_houses(random.randrange(s.height), random.randrange(s.width))

# Use hill-climb to determine hospital placement
hospitals = s.hill_climb(image_prefix = "hospitals", log = True)

# Use random-restart to determine hospital placement
# hospitals = s.random_restart(maximum=10, image_prefix="hospitals_restart_", log=True)
